...
const HomePage: React.FC<RouteComponentProps> = ({ location }) => {
    const { showAlert, handleAlertCancel, handleAlertConfirm } = useExitAlert(location); // Hook to handle the alert of exit when its pressed back button on native apps
