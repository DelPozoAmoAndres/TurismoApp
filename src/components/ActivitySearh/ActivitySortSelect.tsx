...
export const ActivitySortSelect: React.FC = () => {
    ...
    return (
        <IonRow class='ion-justify-content-between'>
            <IonSelect style={{"width":(auth.user?.role===Role.administrador && !isMobile)?"auto":"100%"}} value={1} onIonChange={e => { }} label={t("sort.by")!} labelPlacement='start'>
            ...
            {!isMobile && <IonButton disabled><IonIcon icon={addOutline} />{t("activity.add")}</IonButton>}
        </IonRow>
    )
}
