...
import StripeCheckoutMobileButton from './Mobile/StripeCheckOutMobileButton'
import { StripeCheckOutWebButton } from './Web/StripeCheckOutWebButton'
/* Contexts */
            ...
            {({reservation}) =>
                <>
                    <IonRow class="ion-margin-top">
                        <IonTitle><strong>{t("reservation.data.title")}</strong></IonTitle>
                    </IonRow>
                    <IonRow class="ion-margin-top">
                        <Field
