...
export const Help : React.FC = () => {
  ...
  return (
    <IonGrid style={{width:"100%"}} >
      <IonRow>
        <h2><strong>{t("help.title")}</strong></h2>
      </IonRow>
      ...
      <IonRow>
        <IonButton><IonIcon slot='start' icon={mailOutline} />{t("send.message.email")}</IonButton>
      </IonRow>
      ...
      <IonRow class="ion-align-items-center">
        <IonButton><IonIcon slot='start' icon={logoWhatsapp} />{t("send.message.whatsapp")}</IonButton>
