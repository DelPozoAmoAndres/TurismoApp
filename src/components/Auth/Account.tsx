  ...
  return (
    <IonGrid >
      ...
      <IonRow class="ion-justify-content-between ion-margin-top ion-padding-top">
        <IonButton color={"danger"} ><IonIcon slot='start' icon={trashOutline} />{t("account.delete")}</IonButton>
      </IonRow>
    </IonGrid>
  )
}