...
/* Ionic Components */
import { IonContent, IonItem, IonButton, IonAlert, IonHeader, IonToolbar, IonTitle, IonButtons } from '@ionic/react';
/* Components */
  ...
  const content = (
    <IonContent>
      ...
      <IonAlert
        ...
        header={error ? t('alert.error.title') || 'Error' : t('alert.account.created.title') || ''}
