...
/* Ionic Components */
import { IonMenu, IonHeader, IonToolbar, IonContent, IonList, IonItem, IonIcon, IonLabel, IonMenuToggle, IonRow, IonButton, IonItemDivider } from '@ionic/react';
            ...
            <IonHeader >
                <IonToolbar style={{ "--background": "var(--ion-color-primary)" }}>
                    <IonRow className="ion-margin ion-align-items-center">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Cruz_de_Asturias.svg/1200px-Cruz_de_Asturias.svg.png" width={50} />
                        <IonLabel class='ion-margin-start' style={{ fontSize: "40px", color: "white" }}>Astour</IonLabel>
                    </IonRow>
                </IonToolbar>
            </IonHeader>
            <IonContent>
