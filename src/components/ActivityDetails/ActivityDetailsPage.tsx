...
/* Ionic components */
import { IonContent, IonButton, IonHeader, IonToolbar, IonButtons, IonBackButton, IonIcon, IonAlert, IonRow, IonCard, IonImg } from '@ionic/react';
                ...
                <section className='ion-margin-horizontal'>
                    <IonCard id="activity-image-card" class="ion-no-margin" mode='ios'>
                        <Swiper
                            ...
                            loop
                        >
                            {activityData?.images?.map((imgUrl) =>
                                <SwiperSlide>
                                    <IonImg src={imgUrl} />
                                </SwiperSlide>
                            )}
