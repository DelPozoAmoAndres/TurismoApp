    ...
    <IonContent>
      <IonGrid>
        ...
        <IonRow class="ion-justify-content-center">
          <section>
            <img src="https://cdn.icon-icons.com/icons2/2643/PNG/512/male_man_person_people_avatar_white_tone_icon_159365.png" width={width < 1000 ? 200 : 250} />
            <IonRow>
            ...
            <IonRow>
              <h3>{formatDate(auth.user?.createdAt!)}</h3>
            </IonRow>
          </section >
          {width < maxWidth &&
          ...
          <section className='ion-margin-horizontal' style={{ width: width < maxWidth ? "100%" : 500 }}>
            {(selectedTab == "personalData" || width >= maxWidth) &&
              <PersonalData />}
            {(selectedTab == "help" || width >= maxWidth) &&
              <Help />}
            {(selectedTab == "account" || width >= maxWidth) &&
              <Account />
            }
          </section>
        </IonRow>
