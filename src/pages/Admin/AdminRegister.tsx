...
import { dateValidation, emailValidation, lengthValidation, telephoneValidation } from '../../shared/Validations';
import { RegisterFormData } from '../../models/User';
import { filterPropertiesNotNull, formatDate } from '../../Utils/Utils';


const AdminRegister: React.FC<RouteComponentProps> = ({ history }) => {
            ...
            <IonHeader>
                <IonToolbar mode="ios">
                    ...
                    <IonButtons slot='start'>
                        <IonButton mode="ios" onClick={()=>history.push("/admin/dashboard")}>Cancelar
                        </IonButton>
                    </IonButtons>
                </IonToolbar>
            </IonHeader>
