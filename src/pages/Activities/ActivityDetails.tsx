...
import { FieldConfig, User } from '../../models/User';
            ...
            <IonContent>
                <IonList>
                    <IonItem disabled={!isEditModeActive}>
                        <IonInput value={formData?.name} label='Nombre' labelPlacement='stacked' onIonChange={e => formData && setFormData({...formData, name: e.detail.value!})}></IonInput>
                    </IonItem>
                    <IonItem disabled={!isEditModeActive}>
                        <IonInput  value={formData?.description} label='Descripción' labelPlacement='stacked' onIonChange={e => formData &&  setFormData({...formData, description: e.detail.value!})}></IonInput>
                    </IonItem>
                    <IonItem disabled={!isEditModeActive}>
                        <IonInput  value={formData?.accesibility} label="Accesibilidad" labelPlacement='stacked' onIonChange={e => formData &&  setFormData({...formData, accesibility: e.detail.value!})}></IonInput>
                    </IonItem>
                    <IonItem disabled={!isEditModeActive}>
                        <IonInput value={formData?.location} label="Ubicación" labelPlacement='stacked' onIonChange={e => formData &&  setFormData({...formData, location: e.detail.value!})}></IonInput>
                    </IonItem>
                    <IonItem disabled={!isEditModeActive}>
                        <IonInput value={formData?.duration} label="Duración (minutos)" labelPlacement='stacked' onIonChange={e => formData && setFormData({...formData, duration: Number(e.detail.value!)})}></IonInput>
                    </IonItem>
                    <IonItem disabled={!isEditModeActive}>
                    ...
                    {(isEditModeActive) ?
                        ...
                        :
                        <IonButton expand="block" onClick={() => setEditModeActive(true)}>Editar actividad</IonButton>}
                    <IonButton expand="block" color="danger" onClick={() =>setShowDeleteAlert(true)}>Borrar actividad</IonButton>
                </IonList>
                <IonAlert
                    isOpen={showAlert}
